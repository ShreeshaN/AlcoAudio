...
class ConvNetRunner:
    ...
    def train(self):
        ...
        train_inp_file, train_out_file = 'train_challenge_with_d1_mel_power_to_db_fnot_single_data.npy', 'train_challenge_with_d1_mel_power_to_db_fnot_single_labels.npy'
        dev_inp_file, dev_out_file = 'dev_challenge_with_d1_mel_power_to_db_fnot_single_data.npy', 'dev_challenge_with_d1_mel_power_to_db_fnot_single_labels.npy'
        test_inp_file, test_out_file = 'test_challenge_with_d1_mel_power_to_db_fnot_single_data.npy', 'test_challenge_with_d1_mel_power_to_db_fnot_single_labels.npy'
