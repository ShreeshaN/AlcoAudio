...
class ConvNetRunner:
    ...
    def train(self):
        ...
        train_data, train_labels = self.data_reader(self.data_read_path + 'train_challenge_gaf_data.npy',
                                                    self.data_read_path + 'train_challenge_gaf_labels.npy',
                                                    shuffle=True,
                                                    train=True)
        dev_data, dev_labels = self.data_reader(self.data_read_path + 'dev_challenge_gaf_data.npy',
                                                self.data_read_path + 'dev_challenge_gaf_labels.npy',
                                                shuffle=False, train=False)
        test_data, test_labels = self.data_reader(self.data_read_path + 'test_challenge_gaf_data.npy',
                                                  self.data_read_path + 'test_challenge_gaf_labels.npy',
                                                  shuffle=False, train=False)
